...
if True:   
# if f'{folder}_morphometrics.csv' not in os.listdir('../output/spherical_harmonics/'): 
    data = []
    # cell_list = os.listdir(f'../output/cell_segs_limeseg/Img_2_all/{folder}/')
    if os.path.exists(f'../output/cell_segs_limeseg/{folder}/Results.csv'): 
        results = pd.read_csv(f'../output/cell_segs_limeseg/{folder}/Results.csv')
        print(results.shape)
        ...
        for cell in cell_list: 
            path_ = f'../output/cell_segs_limeseg/{folder}/' + cell + '/T_1.ply_.npy'
            # print(path_)
            if os.path.exists(path_): 
                ...
                # pointcloud = o3d.io.read_point_cloud(path + '/' + cell + '/T_1.ply')
        ...
        data_df.to_csv(f'../output/spherical_harmonics/{folder}_morphometrics.csv')
    else: 
